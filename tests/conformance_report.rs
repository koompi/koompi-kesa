...
//! `KESA_GENERATE_CONFORMANCE_REPORT=1 cargo test --locked --test conformance_report generate_conformance_report -- --exact --nocapture`
...
const GENERATE_CONFORMANCE_REPORT_ENV: &str = "KESA_GENERATE_CONFORMANCE_REPORT";
