...
use kesa::extension_scoring::{VoiCandidate, VoiPlannerConfig, plan_voi_candidates};
...
fn assert_selected_by_priority_order(selected: &[kesa::extension_scoring::VoiPlannedCandidate]) {
