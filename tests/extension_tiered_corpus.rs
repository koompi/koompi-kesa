...
use kesa::extension_license::{ScreeningInput, VerdictStatus, screen_extensions};
...
fn golden_tiered_corpus() {
    ...
    let report: kesa::extension_scoring::ScoringReport = serde_json::from_str(&text).unwrap();
