...
fn performance_git_environment_scrubbing_is_ascii_case_insensitive() {
    let injected = vec![
        ...
        (
            std::ffi::OsString::from("KESA_RELEASE_TEST_SENTINEL"),
    ...
    assert!(command.get_envs().any(|(key, value)| {
        key == "KESA_RELEASE_TEST_SENTINEL"
...
const GENERATE_FINAL_CERTIFICATION_ENV: &str = "KESA_GENERATE_FINAL_CERTIFICATION";
