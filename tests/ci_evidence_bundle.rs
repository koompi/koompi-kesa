...
//!   `KESA_GENERATE_EVIDENCE_BUNDLE=1 cargo test --test ci_evidence_bundle build_evidence_bundle -- --exact --nocapture`
...
const GENERATE_EVIDENCE_BUNDLE_ENV: &str = "KESA_GENERATE_EVIDENCE_BUNDLE";
