...
const STARTUP_P95_MS_ENV: &str = "KESA_PROVIDER_REGISTRY_STARTUP_P95_MS";
const LOOKUP_P99_US_ENV: &str = "KESA_PROVIDER_REGISTRY_LOOKUP_P99_US";
const FOOTPRINT_MB_ENV: &str = "KESA_PROVIDER_REGISTRY_FOOTPRINT_MB";
const RSS_DELTA_MB_ENV: &str = "KESA_PROVIDER_REGISTRY_RSS_DELTA_MB";
