...
const GENERATE_LIFECYCLE_HOOK_PARITY_ARTIFACT_ENV: &str =
    "KESA_GENERATE_LIFECYCLE_HOOK_PARITY_ARTIFACT";
...
fn build_lifecycle_hook_parity_artifact(
    ...
    json!({
        ...
        "reproduce_command": "KESA_GENERATE_LIFECYCLE_HOOK_PARITY_ARTIFACT=1 cargo test --test extensions_event_wiring lifecycle_hook_parity_matrix_writes_evidence_artifact -- --exact --nocapture",
    })
}
