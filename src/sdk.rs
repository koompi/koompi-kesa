...
//! Prefer importing from `kesa::sdk` instead of deep internal modules.
//!
//! # Examples
//!
//! ```rust
//! use kesa::sdk::{AgentEvent, Message, ToolDefinition};
//!
...
pub async fn create_agent_session(options: SessionOptions) -> Result<AgentSessionHandle> {
    ...
    let system_prompt = app::build_system_prompt(
        ...
        &global_dir,
        &package_dir,
        crate::env::var_os("TEST_MODE").is_some(),
