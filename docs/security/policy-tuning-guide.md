...
|-----------|-----------|---------|---------|-------|
| `enabled` | `extension_risk.enabled` | `KESA_EXTENSION_RISK_ENABLED` | `false` | bool |
| `enforce` | `extension_risk.enforce` | `KESA_EXTENSION_RISK_ENFORCE` | `true` | bool |
| `alpha` | `extension_risk.alpha` | `KESA_EXTENSION_RISK_ALPHA` | `0.01` | 1e-6..0.5 |
| `window_size` | `extension_risk.windowSize` | `KESA_EXTENSION_RISK_WINDOW` | `128` | 8..4096 |
| `ledger_limit` | `extension_risk.ledgerLimit` | `KESA_EXTENSION_RISK_LEDGER_LIMIT` | `2048` | 32..20000 |
| `decision_timeout_ms` | `extension_risk.decisionTimeoutMs` | `KESA_EXTENSION_RISK_DECISION_TIMEOUT_MS` | `50` | 1..2000 |
| `fail_closed` | `extension_risk.failClosed` | `KESA_EXTENSION_RISK_FAIL_CLOSED` | `true` | bool |
...
# Environment
export KESA_EXTENSION_POLICY=safe
...
2. Switch to Shadow mode first: `KESA_EXTENSION_RISK_ENFORCE=false`
...
2. Check if risk controller was enabled (`KESA_EXTENSION_RISK_ENABLED`)
